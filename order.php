    ...
    <div class="container">
        ...
        <form action="" class="order" method="POST">
            ...
            <fieldset>
                ...
                <input type="email" name="email" placeholder="E.g. johndoe@example.com" class="input-responsive" required>
        ...
        if (isset($_POST['submit'])) {
            ...
            $custoemr_address = $_POST['address'];
            ...
            customer_address = '$custoemr_address'
            ";
            //   echo $sql2; die();
